...
<%@include file="../header.jsp" %>
    ...
    <div class="c-flex-container">
        ...
        <div class="p-back-btn">
            <a href="/kouka/manage/detail?id=<%= request.getParameter("id") %>"><button type="button" class="c-btn c-btn--back">戻る</button></a>
        </div>
        <!-- 登録ボタン -->
        <form action="/kouka/manage/update" method="post">
